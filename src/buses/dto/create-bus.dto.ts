...
import { IsString, IsOptional, IsInt, Min, IsArray, ValidateNested, IsBoolean, IsNumber } from 'class-validator';
...
export class CreateSeatLayoutDto {
  ...
  @ApiProperty({ description: 'Seat type', enum: SeatType, default: SeatType.REGULAR })
  @IsOptional()
  @IsString()
  seatType?: SeatType;

  @ApiProperty({ description: 'Seat position', enum: SeatPosition, required: false })
  @IsOptional()
  @IsString()
...
export class CreateBusDto {
  ...
  @ApiProperty({ description: 'Bus brand', required: false, example: 'Mercedes' })
  @IsOptional()
  @IsString()
  brand?: string;
  ...
  @ApiProperty({ description: 'Seat layouts', type: [CreateSeatLayoutDto], required: false })
  @IsOptional()
  @IsArray()
