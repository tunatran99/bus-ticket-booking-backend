...
export class InitialSchema1764862922708 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "permissions" ("id" SERIAL NOT NULL, "name" character varying(120) NOT NULL, "description" character varying(255), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_48ce552495d14eae9b187bb6716" UNIQUE ("name"), CONSTRAINT "PK_920331560282b8bd21bb02290df" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "user_roles" ("user_id" character varying(100) NOT NULL, "role_id" integer NOT NULL, CONSTRAINT "PK_23ed6f04fe43066df08379fd034" PRIMARY KEY ("user_id", "role_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "route_stops" ADD CONSTRAINT "FK_352e45964a86c097a435f643004" FOREIGN KEY ("routeId") REFERENCES "routes"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "seat_layouts" ADD CONSTRAINT "FK_e3a5c4e319374dda9d0905ee6b9" FOREIGN KEY ("busId") REFERENCES "buses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "trips" ADD CONSTRAINT "FK_3fcad6442389eeb7aea5f1f25a8" FOREIGN KEY ("routeId") REFERENCES "routes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "trips" ADD CONSTRAINT "FK_5cb200e0bc5828053dd3d60cfd8" FOREIGN KEY ("busId") REFERENCES "buses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "trips" DROP CONSTRAINT "FK_5cb200e0bc5828053dd3d60cfd8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "trips" DROP CONSTRAINT "FK_3fcad6442389eeb7aea5f1f25a8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "seat_layouts" DROP CONSTRAINT "FK_e3a5c4e319374dda9d0905ee6b9"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_60e98baaa0f9fed12eb11a2a27"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8ee34d0a74c7fadb84bf8561c8"`,
    );
    await queryRunner.query(`DROP TABLE "trips"`);
    await queryRunner.query(`DROP TYPE "public"."trips_status_enum"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_30451cb6cc6ff3c13a64a8e166"`,
    );
    await queryRunner.query(`DROP TABLE "buses"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_1e42e69a5c2fcf6d6c8d4e6334"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_36bb5d65a60351a7720938908c"`,
    );
